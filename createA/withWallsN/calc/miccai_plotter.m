...
for c = 1:4
    ...
    if sum(p_xz(:)) > 3
        ...
        if pos == 1 || pos == 2 || pos ==  3 || pos == 4 || pos == 5 || pos ==  8
            plot3(z_,x_,max(xview(:)),'co')
        end
        if pos == 2 || pos ==  6
            plot3(z_+dist,x_,max(xview(:)),'co')
        end
        if pos == 3 || pos == 6
            plot3(z_-dist,x_,max(xview(:)),'co')
        end
        if pos == 5
            plot3(z_-dist,x_+5,max(xview(:)),'co')
        end
        grid off
        hold off
        ...
        hold on
        if pos == 1 || pos == 2 || pos ==  3 || pos == 4 || pos == 5 || pos ==  8
            plot3(z_,y_+1,max(yview(:)),'co')
        end
        if pos == 2 || pos ==  6
            plot3(z_+dist,y_,max(yview(:)),'co')
        end
        if pos == 3 || pos == 6
            plot3(z_-dist,y_,max(yview(:)),'co')
        end
        if pos == 5
            plot3(z_-dist,y_-20,max(yview(:)),'co')
        end
        grid off
        hold off
